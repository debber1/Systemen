...
\hypersetup{
	pdftitle={Derivations Mathematical systems},
...
These are the derivations for mathematical systems. \href{https://github.com/debber1/Systemen}{The source code for this document can be found on github.} 
...
\href{https://www.instagram.com/pnagels.2004/}{Pieter Nagels}\\
\href{https://github.com/mardybumsz}{Vivian Tsang}
\newpage
...
\newpage
\subfile{sections/FTC_Block_Signal.tex}
\newpage
\subfile{sections/descriptionOfLTC.tex}
\newpage
\subfile{sections/impulseResponse.tex}
\newpage
\subfile{sections/polesAndZeros.tex}
\newpage
\subfile{sections/characteristicPolynomial.tex}
\end{document}
